classdef SparseGoalGBWMEnvironment < rl.env.MATLABEnvironment
    ...
    methods              
        ...
        function this = SparseGoalGBWMEnvironment(G, T, grid, cash, w0_idx, pwgt, pret, prsk, simulate_n_periods, simulate_dt, simulate_n_trials)
    ...
    methods               
        ...
        function Reward = construct_reward(this)
            if this.grid(this.cur_w) >= this.G && this.t > this.T - 1 
